    ...
    <div class="footer-meta">
        <div class="footer-container">
            ...
            <div class="meta-item meta-posts">
                <h3 class="meta-title" style="font-weight: bold; color: #4CAF50; font-size: 16px;">最新发布</h3>
                <?php getRecentPosts($this,8); ?>
            </div>
            <div class="meta-item meta-tags">
                <h3 class="meta-title" style="font-weight: bold; color: #ec565b; font-size: 16px;">热门标签</h3>
